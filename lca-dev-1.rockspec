...
build = {
	...
	modules = {
		...
		["agent.effects.squall"] = "lua/agent/effects/squall.lua",
		...
		["agent.background"] = "lua/agent/background.lua",
		...
		["agent.tools.apply_patch"] = "lua/agent/tools/apply_patch.lua",
        ["agent.patch_diff"] = "lua/agent/patch_diff.lua",
        ["agent.patch_validation"] = "lua/agent/patch_validation.lua",
	...
	copy_directories = { "microvm", "c", "bin", "scripts", "licenses" },
	install = {
		bin = {
			["lca"] = "bin/lca",
			["lca-background"] = "bin/background.lua",
