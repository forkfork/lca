...
class InstalledPackageTests(unittest.TestCase):
 def test_deployed_lua_sources_included_without_checkout(self):
  with tempfile.TemporaryDirectory() as tmp:
   ...
   for name in ['c/crypto.c','bin/lca','scripts/auth.lua','scripts/login.lua','microvm/bootstrap.lua','microvm/smoke.sh','microvm/worker.lua','microvm/lifecycle.lua','microvm/publish.lua','microvm/headless.lua','microvm/checkpoint.lua','microvm/events.lua','microvm/fixture/test','microvm/Dockerfile']:
