...
app:_handle_action({type='submit',text='/cloud'})
assert(app:next_submission()=='/cloud','cloud must preserve attach intent')
assert(app.submitted[1]=='first' and app.submitted[2]=='second','cloud preserves queued work')
